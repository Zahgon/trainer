...
func Enabled(f featuregate.Feature) bool { _ = "STUB: not implemented"; return false }
...
func SetEnable(f featuregate.Feature, v bool) error { _ = "STUB: not implemented"; return nil }
